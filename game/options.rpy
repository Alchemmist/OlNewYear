...
define config.name = _("С новым годом")
...
define gui.about = _p("""
    Это игра созданная коллективом юношей 2006 года рождения спортивной школы 
    олимпийского резерва для своего тренера, Кошкарёвой Ольги Леонидовны, в честь наступления 2024 года. А если быть точнее,
    для более увлектального поедения пирожных))
""")
...
define config.save_directory = "OlNewYear-1703794054"
